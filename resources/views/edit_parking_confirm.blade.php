...
<main>
    <div class="w-50 text-center mx-auto my-5 d-flex flex-column justify-content-around">
        ...
        <form method="POST" action="{{ route('edit_parking_complete') }}" class="mt-3 mb-5">
        @csrf
            <!-- 登録するデータ -->
            <!-- 駐車場ID -->
            <input type="hidden" value="{{ $inputs['parking_id'] }}" name="parking_id">
            <!-- 観光地id -->
            ...
            <div class="d-grid d-md-none gap-2 col-md-5 my-3">
                <button type="submit" class="text-center btn-lg mt-4" name="action" value="edit">変更</button>
            </div>
            <!-- md～の表示画面 -->
            <div class="d-none d-md-flex justify-content-between">
                ...
                <div class="d-grid gap-2 col-md-5 my-3">
                    <button type="submit" class="text-center btn-lg mt-4 py-3" name="action" value="edit">変更</button>
                </div>
            </div>
        </form>
    </div>
